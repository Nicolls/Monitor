...
package com.nicolls.ablum.activity;
...
import com.nicolls.ablum.fragment.BucketImageFragment;
...
//				Toast.makeText(getApplicationContext(),tabId,Toast.LENGTH_LONG).show();
		...
		if(TextUtils.equals(mediaType,MediaChooserConstants.TYPE_PHOTO)){//当前图片。显示视频按钮
